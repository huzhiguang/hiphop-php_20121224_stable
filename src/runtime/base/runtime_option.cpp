...
int RuntimeOption::ServerThreadCount = Process::GetCPUCount();
...
//wanghong add
bool RuntimeOption::MySQLISPERSISTENT = false;
bool RuntimeOption::MsSQLISPERSISTENT = false;
int RuntimeOption::MsSQLConnectTimeout = 1000;
int RuntimeOption::MsSQLReadTimeout = 1000;
//////////////
...
//    ServerPrimaryIP = Util::GetPrimaryIP();
    ...
    // yfliulei@360buy.com, 2012-11-2
    //
    ServerPrimaryIP = Util::GetPrimaryIP_ioctl();
    ...
    int cpucount=Process::GetCPUCount();
//    ServerThreadCount = server["ThreadCount"].getInt32(50);
      ServerThreadCount = server["ThreadCount"].getInt32(cpucount);
  ...
  }
  {
    ...
    //wanghong add
    MySQLISPERSISTENT = mysql["ISPERSISTENT"].getBool(false);
    /////////////
  }
  //wanghong add
  {
    Hdf mssql = config["MsSQL"];
    MsSQLISPERSISTENT = mssql["ISPERSISTENT"].getBool(false);
    MsSQLConnectTimeout = mssql["ConnectTimeout"].getInt32(1000);
    MsSQLReadTimeout = mssql["ReadTimeout"].getInt32(1000);
  }
  //////////////
  {
