...
char *string_html_encode_GB2312(const char *input, int &len, bool encode_double_quote,
						 bool encode_single_quote, bool utf8, bool nbsp); // add by yfliulei@360buy.com on 2013-1-14
