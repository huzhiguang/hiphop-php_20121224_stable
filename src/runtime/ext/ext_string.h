...
inline String f_htmlspecialchars(CStrRef str, int quote_style = k_ENT_COMPAT,
  ...
  // add by yfliulei@360buy.com on 2013-1-14 Monday
  if ( strcasecmp(scharset, "GB2312") == 0 ) {
	return StringUtil::HtmlEncode_GB2312(str, (StringUtil::QuoteStyle)quote_style, false);
  } else {
	return StringUtil::HtmlEncode(str, (StringUtil::QuoteStyle)quote_style,
                                scharset, false);
  }
