...
TypedValue* fg_ice_initialize(VM::ActRec *ar);
TypedValue* fg_icephp_defineproxy(VM::ActRec *ar);
TypedValue* fg_icephp_declareclass(VM::ActRec *ar);
TypedValue* fg_icephp_defineexception(VM::ActRec *ar);
TypedValue* fg_create_typeinfobyid(VM::ActRec *ar);
TypedValue* fg_icephp_stringifyexception(VM::ActRec *ar);
TypedValue* fg_icephp_stringify(VM::ActRec *ar);
TypedValue* fg_icephp_definesequence(VM::ActRec *ar);
TypedValue* fg_icephp_defineclass(VM::ActRec *ar);
TypedValue* fg_icephp_defineoperation(VM::ActRec *ar);
TypedValue* fg_ice_find(VM::ActRec *ar);
TypedValue* fg_ice_register(VM::ActRec *ar);
...
TypedValue* fg_mssql_connect(VM::ActRec *ar);
TypedValue* fg_mssql_pconnect(VM::ActRec *ar);
TypedValue* fg_mssql_close(VM::ActRec *ar);
TypedValue* fg_mssql_select_db(VM::ActRec *ar);
TypedValue* fg_mssql_query(VM::ActRec *ar);
TypedValue* fg_mssql_num_rows(VM::ActRec *ar);
TypedValue* fg_mssql_rows_affected(VM::ActRec *ar);
TypedValue* fg_mssql_fetch_row(VM::ActRec *ar);
TypedValue* fg_mssql_fetch_assoc(VM::ActRec *ar);
TypedValue* fg_mssql_free_result(VM::ActRec *ar);
TypedValue* fg_mssql_get_last_message(VM::ActRec *ar);
...
TypedValue* fg_is_hhvm_func(VM::ActRec *ar);
...
TypedValue* fg_xcache_set(VM::ActRec *ar);
TypedValue* fg_xcache_get(VM::ActRec *ar);
TypedValue* fg_xcache_inc(VM::ActRec *ar);
TypedValue* fg_xcache_unset(VM::ActRec *ar);
...
VM::Instance* new_ICE_Instance(VM::Class*);
TypedValue* tg_3ICE___construct(VM::ActRec *ar);
TypedValue* tg_3ICE_stringToProxy(VM::ActRec *ar);
VM::Instance* new_Proxy_Instance(VM::Class*);
TypedValue* tg_5Proxy___construct(VM::ActRec *ar);
TypedValue* tg_5Proxy___call(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_oneway(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_datagram(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_isTwoway(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_secure(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_timeout(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_context(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_checkedCast(VM::ActRec *ar);
TypedValue* tg_5Proxy_ice_uncheckedcast(VM::ActRec *ar);
VM::Instance* new_IcePHP_class_Instance(VM::Class*);
TypedValue* tg_12IcePHP_class___construct(VM::ActRec *ar);
VM::Instance* new_TypeInfo_Instance(VM::Class*);
TypedValue* tg_8TypeInfo___construct(VM::ActRec *ar);
...
VM::Instance* new_Mongo_Instance(VM::Class*);
TypedValue* tg_5Mongo___construct(VM::ActRec *ar);
TypedValue* tg_5Mongo___get(VM::ActRec *ar);
TypedValue* tg_5Mongo_selectDB(VM::ActRec *ar);
TypedValue* tg_5Mongo___destruct(VM::ActRec *ar);
TypedValue* tg_5Mongo_close(VM::ActRec *ar);
VM::Instance* new_MongoDB_Instance(VM::Class*);
TypedValue* tg_7MongoDB___construct(VM::ActRec *ar);
TypedValue* tg_7MongoDB___get(VM::ActRec *ar);
TypedValue* tg_7MongoDB_selectCollection(VM::ActRec *ar);
TypedValue* tg_7MongoDB___destruct(VM::ActRec *ar);
VM::Instance* new_MongoCollection_Instance(VM::Class*);
TypedValue* tg_15MongoCollection___construct(VM::ActRec *ar);
TypedValue* tg_15MongoCollection_find(VM::ActRec *ar);
TypedValue* tg_15MongoCollection___destruct(VM::ActRec *ar);
VM::Instance* new_MongoCursor_Instance(VM::Class*);
TypedValue* tg_11MongoCursor___construct(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_current(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_key(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_next(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_rewind(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_valid(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_limit(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_sort(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_skip(VM::ActRec *ar);
TypedValue* tg_11MongoCursor_info(VM::ActRec *ar);
TypedValue* tg_11MongoCursor___destruct(VM::ActRec *ar);
VM::Instance* new_MongoDate_Instance(VM::Class*);
TypedValue* tg_9MongoDate___construct(VM::ActRec *ar);
TypedValue* tg_9MongoDate___get(VM::ActRec *ar);
TypedValue* tg_9MongoDate___set(VM::ActRec *ar);
VM::Instance* new_MssqlResult_Instance(VM::Class*);
TypedValue* tg_11MssqlResult___construct(VM::ActRec *ar);
TypedValue* tg_11MssqlResult___toString(VM::ActRec *ar);
...
const long long hhbc_ext_funcs_count = 2220;
const HhbcExtFuncInfo hhbc_ext_funcs[] = {
  ...
  { "ice_initialize", fg_ice_initialize, (void *)&fh_ice_initialize },
  { "icephp_defineproxy", fg_icephp_defineproxy, (void *)&fh_icephp_defineproxy },
  { "icephp_declareclass", fg_icephp_declareclass, (void *)&fh_icephp_declareclass },
  { "icephp_defineexception", fg_icephp_defineexception, (void *)&fh_icephp_defineexception },
  { "create_typeinfobyid", fg_create_typeinfobyid, (void *)&fh_create_typeinfobyid },
  { "icephp_stringifyexception", fg_icephp_stringifyexception, (void *)&fh_icephp_stringifyexception },
  { "icephp_stringify", fg_icephp_stringify, (void *)&fh_icephp_stringify },
  { "icephp_definesequence", fg_icephp_definesequence, (void *)&fh_icephp_definesequence },
  { "icephp_defineclass", fg_icephp_defineclass, (void *)&fh_icephp_defineclass },
  { "icephp_defineoperation", fg_icephp_defineoperation, (void *)&fh_icephp_defineoperation },
  { "ice_find", fg_ice_find, (void *)&fh_ice_find },
  { "ice_register", fg_ice_register, (void *)&fh_ice_register },
  ...
  { "mssql_connect", fg_mssql_connect, (void *)&fh_mssql_connect },
  { "mssql_pconnect", fg_mssql_pconnect, (void *)&fh_mssql_pconnect },
  { "mssql_close", fg_mssql_close, (void *)&fh_mssql_close },
  { "mssql_select_db", fg_mssql_select_db, (void *)&fh_mssql_select_db },
  { "mssql_query", fg_mssql_query, (void *)&fh_mssql_query },
  { "mssql_num_rows", fg_mssql_num_rows, (void *)&fh_mssql_num_rows },
  { "mssql_rows_affected", fg_mssql_rows_affected, (void *)&fh_mssql_rows_affected },
  { "mssql_fetch_row", fg_mssql_fetch_row, (void *)&fh_mssql_fetch_row },
  { "mssql_fetch_assoc", fg_mssql_fetch_assoc, (void *)&fh_mssql_fetch_assoc },
  { "mssql_free_result", fg_mssql_free_result, (void *)&fh_mssql_free_result },
  { "mssql_get_last_message", fg_mssql_get_last_message, (void *)&fh_mssql_get_last_message },
  ...
  { "is_hhvm_func", fg_is_hhvm_func, (void *)&fh_is_hhvm_func },
  ...
  { "xcache_set", fg_xcache_set, (void *)&fh_xcache_set },
  { "xcache_get", fg_xcache_get, (void *)&fh_xcache_get },
  { "xcache_inc", fg_xcache_inc, (void *)&fh_xcache_inc },
  { "xcache_unset", fg_xcache_unset, (void *)&fh_xcache_unset },
...
static const long long hhbc_ext_method_count_ICE = 2;
static const HhbcExtMethodInfo hhbc_ext_methods_ICE[] = {
  { "__construct", tg_3ICE___construct },
  { "stringToProxy", tg_3ICE_stringToProxy }
};

static const long long hhbc_ext_method_count_Proxy = 10;
static const HhbcExtMethodInfo hhbc_ext_methods_Proxy[] = {
  { "__construct", tg_5Proxy___construct },
  { "__call", tg_5Proxy___call },
  { "ice_oneway", tg_5Proxy_ice_oneway },
  { "ice_datagram", tg_5Proxy_ice_datagram },
  { "ice_isTwoway", tg_5Proxy_ice_isTwoway },
  { "ice_secure", tg_5Proxy_ice_secure },
  { "ice_timeout", tg_5Proxy_ice_timeout },
  { "ice_context", tg_5Proxy_ice_context },
  { "ice_checkedCast", tg_5Proxy_ice_checkedCast },
  { "ice_uncheckedcast", tg_5Proxy_ice_uncheckedcast }
};

static const long long hhbc_ext_method_count_IcePHP_class = 1;
static const HhbcExtMethodInfo hhbc_ext_methods_IcePHP_class[] = {
  { "__construct", tg_12IcePHP_class___construct }
};

static const long long hhbc_ext_method_count_TypeInfo = 1;
static const HhbcExtMethodInfo hhbc_ext_methods_TypeInfo[] = {
  { "__construct", tg_8TypeInfo___construct }
};
...
static const long long hhbc_ext_method_count_Mongo = 5;
static const HhbcExtMethodInfo hhbc_ext_methods_Mongo[] = {
  { "__construct", tg_5Mongo___construct },
  { "__get", tg_5Mongo___get },
  { "selectDB", tg_5Mongo_selectDB },
  { "__destruct", tg_5Mongo___destruct },
  { "close", tg_5Mongo_close }
};

static const long long hhbc_ext_method_count_MongoDB = 4;
static const HhbcExtMethodInfo hhbc_ext_methods_MongoDB[] = {
  { "__construct", tg_7MongoDB___construct },
  { "__get", tg_7MongoDB___get },
  { "selectCollection", tg_7MongoDB_selectCollection },
  { "__destruct", tg_7MongoDB___destruct }
};

static const long long hhbc_ext_method_count_MongoCollection = 3;
static const HhbcExtMethodInfo hhbc_ext_methods_MongoCollection[] = {
  { "__construct", tg_15MongoCollection___construct },
  { "find", tg_15MongoCollection_find },
  { "__destruct", tg_15MongoCollection___destruct }
};

static const long long hhbc_ext_method_count_MongoCursor = 11;
static const HhbcExtMethodInfo hhbc_ext_methods_MongoCursor[] = {
  { "__construct", tg_11MongoCursor___construct },
  { "current", tg_11MongoCursor_current },
  { "key", tg_11MongoCursor_key },
  { "next", tg_11MongoCursor_next },
  { "rewind", tg_11MongoCursor_rewind },
  { "valid", tg_11MongoCursor_valid },
  { "limit", tg_11MongoCursor_limit },
  { "sort", tg_11MongoCursor_sort },
  { "skip", tg_11MongoCursor_skip },
  { "info", tg_11MongoCursor_info },
  { "__destruct", tg_11MongoCursor___destruct }
};

static const long long hhbc_ext_method_count_MongoDate = 3;
static const HhbcExtMethodInfo hhbc_ext_methods_MongoDate[] = {
  { "__construct", tg_9MongoDate___construct },
  { "__get", tg_9MongoDate___get },
  { "__set", tg_9MongoDate___set }
};

static const long long hhbc_ext_method_count_MssqlResult = 2;
static const HhbcExtMethodInfo hhbc_ext_methods_MssqlResult[] = {
  { "__construct", tg_11MssqlResult___construct },
  { "__toString", tg_11MssqlResult___toString }
};
...
const HhbcExtClassInfo hhbc_ext_classes[] = {
  ...
  { "ICE", new_ICE_Instance, sizeof(c_ICE), hhbc_ext_method_count_ICE, hhbc_ext_methods_ICE },
  { "Proxy", new_Proxy_Instance, sizeof(c_Proxy), hhbc_ext_method_count_Proxy, hhbc_ext_methods_Proxy },
  { "IcePHP_class", new_IcePHP_class_Instance, sizeof(c_IcePHP_class), hhbc_ext_method_count_IcePHP_class, hhbc_ext_methods_IcePHP_class },
  { "TypeInfo", new_TypeInfo_Instance, sizeof(c_TypeInfo), hhbc_ext_method_count_TypeInfo, hhbc_ext_methods_TypeInfo },
  ...
  { "Mongo", new_Mongo_Instance, sizeof(c_Mongo), hhbc_ext_method_count_Mongo, hhbc_ext_methods_Mongo },
  { "MongoDB", new_MongoDB_Instance, sizeof(c_MongoDB), hhbc_ext_method_count_MongoDB, hhbc_ext_methods_MongoDB },
  { "MongoCollection", new_MongoCollection_Instance, sizeof(c_MongoCollection), hhbc_ext_method_count_MongoCollection, hhbc_ext_methods_MongoCollection },
  { "MongoCursor", new_MongoCursor_Instance, sizeof(c_MongoCursor), hhbc_ext_method_count_MongoCursor, hhbc_ext_methods_MongoCursor },
  { "MongoDate", new_MongoDate_Instance, sizeof(c_MongoDate), hhbc_ext_method_count_MongoDate, hhbc_ext_methods_MongoDate },
  { "MssqlResult", new_MssqlResult_Instance, sizeof(c_MssqlResult), hhbc_ext_method_count_MssqlResult, hhbc_ext_methods_MssqlResult },
